...
public class StudentDaoJdbcTemplateImpl implements IStudentDao {
	...
	public boolean add(Student student) {
		// TODO Auto-generated method stub
		int n = this.jdbcTemplate.update(this.SQL_INSERT, new Object[] {student.getName(), student.getEmail(),student.getCountry()});
	...
	public boolean update(Student student) {
		// TODO Auto-generated method stub
		int n = this.jdbcTemplate.update(this.SQL_UPDATE, new Object[] {student.getName(), student.getEmail(), student.getId(),student.getCountry()});
		// n : number of rows affected
		if(n>0)
			return true;
		return false;
